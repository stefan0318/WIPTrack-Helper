...
class WIPTrackToExcelHelper(QWidget):
    def __init__(self):
        super().__init__()
        self.init_ui()
        self.comments_data = []
    ...
    def init_ui(self):
        self.setWindowTitle("WIPTrack-XL Data Helper")
        ...
        # OK button
        self.ok_button = QPushButton("Write Data to XL")
        self.ok_button.clicked.connect(self.write_comments_data)
    ...
    def write_comments_data(self):
        from src.excel_functions import write_lot_data_into_excel_file

        write_lot_data_into_excel_file(self.transfer_id_input.text())
